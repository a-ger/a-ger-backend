 ...
 */
@Entity
class Comment : BaseEntity, Serializable {
    @Id
    ...
    constructor(commentId: Long?, boardId: Board?, accountId: Account?, commentContent: String?) {
    ...
    class CommentBuilder internal constructor() {
        ...
        private var boardId: Board? = null
        private var accountId: Account? = null
        private var commentContent: String? = null
        fun commentId(commentId: Long?): CommentBuilder {
            this.commentId = commentId
            return this
        }

        fun boardId(boardId: Board?): CommentBuilder {
            this.boardId = boardId
            return this
        }

        fun accountId(accountId: Account?): CommentBuilder {
            this.accountId = accountId
            return this
        }

        fun commentContent(commentContent: String?): CommentBuilder {
            this.commentContent = commentContent
            return this
        }

        fun build(): Comment {
            return Comment(commentId, boardId, accountId, commentContent)
        }

        override fun toString(): String {
            return "Comment.CommentBuilder(commentId=" + commentId + ", boardId=" + boardId + ", accountId=" + accountId + ", commentContent=" + commentContent + ")"
        }
    }
