...
interface BoardRepositoryCustom {
    fun findAllBoardPageableOrderByCreatedAtDesc(keyword: String, pageable: Pageable): Slice<BoardSummaryResponse>
    fun findBoardsByAccountId(accountId: Long?, pageable: Pageable): Slice<BoardSummaryResponse>
    fun addViewCntFromRedis(productId: Long?, viewCnt: Long?)
    fun addViewCnt(boardId: Long?): Board?
}