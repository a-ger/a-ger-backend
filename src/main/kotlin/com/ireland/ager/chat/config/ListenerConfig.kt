...
class ListenerConfig {
     ...
     * @Description :
     * @Parameter : []
     * @Return : ConcurrentKafkaListenerContainerFactory<String></String>, MessageRequest>
     */
    @Bean
    fun kafkaListenerContainerFactory(): ConcurrentKafkaListenerContainerFactory<String, MessageRequest> {
        val factory = ConcurrentKafkaListenerContainerFactory<String, MessageRequest>()
     ...
     * @Description :
     * @Parameter : []
     * @Return : ConsumerFactory<String></String>, MessageRequest>
     */
    @Bean
    ...
    fun consumerConfigurations(): Map<String, Any> {
        ...
        configurations[ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG] =
