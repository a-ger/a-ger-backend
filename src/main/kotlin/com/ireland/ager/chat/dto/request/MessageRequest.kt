package com.ireland.ager.chat.dto.requestimport
 ...
 */
class MessageRequest : Serializable {
    var roomId: Long? = null
    var senderId: Long? = null
    var message: String? = null

    constructor(roomId: Long?, senderId: Long?, message: String?) {
        this.roomId = roomId
    ...
    override fun equals(o: Any?): Boolean {
        ...
        if (o !is MessageRequest) return false
        val other = o
        if (!other.canEqual(this as Any)) return false
        val `this$roomId`: Any? = roomId
        val `other$roomId`: Any? = other.roomId
        if (if (`this$roomId` == null) `other$roomId` != null else `this$roomId` != `other$roomId`) return false
        val `this$senderId`: Any? = senderId
        val `other$senderId`: Any? = other.senderId
        if (if (`this$senderId` == null) `other$senderId` != null else `this$senderId` != `other$senderId`) return false
    ...
    override fun hashCode(): Int {
        val PRIME = 59
        var result = 1
        val `$roomId`: Any? = roomId
        result = result * PRIME + (`$roomId`?.hashCode() ?: 43)
        val `$senderId`: Any? = senderId
        result = result * PRIME + (`$senderId`?.hashCode() ?: 43)
    ...
    override fun toString(): String {
        return "MessageRequest(roomId=" + roomId + ", senderId=" + senderId + ", message=" + message + ")"
    }

    class MessageRequestBuilder internal constructor() {
        private var roomId: Long? = null
        private var senderId: Long? = null
        private var message: String? = null
        fun roomId(roomId: Long?): MessageRequestBuilder {
            this.roomId = roomId
            return this
        }

        fun senderId(senderId: Long?): MessageRequestBuilder {
            this.senderId = senderId
            return this
        }

        fun message(message: String?): MessageRequestBuilder {
            this.message = message
            return this
        }

        fun build(): MessageRequest {
            return MessageRequest(roomId, senderId, message)
        }

        override fun toString(): String {
            return "MessageRequest.MessageRequestBuilder(roomId=" + roomId + ", senderId=" + senderId + ", message=" + message + ")"
        }
    }
    ...
    companion object {
         ...
         * @Return : Message
         */
        fun toMessage(messageDto: MessageRequest, messageRoom: MessageRoom?): Message {
            return Message.Companion.builder()
