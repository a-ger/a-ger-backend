package com.ireland.ager.chat.dto.responseimport
 ...
 */
class MessageDetailsResponse internal constructor(var roomId: Long?, var reviewStatus: String?) {

    class MessageDetailsResponseBuilder internal constructor() {
        private var roomId: Long? = null
        private var reviewStatus: String? = null
        fun roomId(roomId: Long?): MessageDetailsResponseBuilder {
            this.roomId = roomId
            return this
        }

        fun reviewStatus(reviewStatus: String?): MessageDetailsResponseBuilder {
            this.reviewStatus = reviewStatus
            return this
        }

        fun build(): MessageDetailsResponse {
            return MessageDetailsResponse(roomId, reviewStatus)
        }

        override fun toString(): String {
            return "MessageDetailsResponse.MessageDetailsResponseBuilder(roomId=" + roomId + ", reviewStatus=" + reviewStatus + ")"
        }
    }
    ...
    companion object {
         ...
         */
        fun toMessageDetailsResponse(messageRoom: MessageRoom): MessageDetailsResponse {
            return MessageDetailsResponse.Companion.builder()
                .roomId(messageRoom.roomId)
                .reviewStatus(messageRoom.reviewStatus.name)
                .build()
        }

        fun builder(): MessageDetailsResponseBuilder {
            return MessageDetailsResponseBuilder()
        }
    }
}