package com.ireland.ager.chat.dto.responseimportimport

com.ireland.ager.chat.entity.*
 ...
 */
class MessageSummaryResponse internal constructor(
    var roomId: Long?,
    var accountNickname: String?,
    var accountThumbnail: String?,
    var latestMessage: String?,
    var latestAt: LocalDateTime?
) {

    class MessageSummaryResponseBuilder internal constructor() {
        private var roomId: Long? = null
        private var accountNickname: String? = null
        private var accountThumbnail: String? = null
        private var latestMessage: String? = null
        private var latestAt: LocalDateTime? = null
        fun roomId(roomId: Long?): MessageSummaryResponseBuilder {
            this.roomId = roomId
            return this
        }

        fun accountNickname(accountNickname: String?): MessageSummaryResponseBuilder {
            this.accountNickname = accountNickname
            return this
        }

        fun accountThumbnail(accountThumbnail: String?): MessageSummaryResponseBuilder {
            this.accountThumbnail = accountThumbnail
            return this
        }

        fun latestMessage(latestMessage: String?): MessageSummaryResponseBuilder {
            this.latestMessage = latestMessage
            return this
        }

        fun latestAt(latestAt: LocalDateTime?): MessageSummaryResponseBuilder {
            this.latestAt = latestAt
            return this
        }

        fun build(): MessageSummaryResponse {
            return MessageSummaryResponse(roomId, accountNickname, accountThumbnail, latestMessage, latestAt)
        }

        override fun toString(): String {
            return "MessageSummaryResponse.MessageSummaryResponseBuilder(roomId=" + roomId + ", accountNickname=" + accountNickname + ", accountThumbnail=" + accountThumbnail + ", latestMessage=" + latestMessage + ", latestAt=" + latestAt + ")"
        }
    }
    ...
    companion object {
         ...
         */
        fun toMessageSummaryResponse(
            messageRoom: MessageRoom, account: Account, message: Message
        ): MessageSummaryResponse {
            return MessageSummaryResponse.Companion.builder()
                .roomId(messageRoom.roomId)
                .accountNickname(account.profileNickname)
                .accountThumbnail(account.profileImageUrl)
                .latestMessage(message.message)
                .latestAt(message.createdAt)
                .build()
        }

        fun builder(): MessageSummaryResponseBuilder {
            return MessageSummaryResponseBuilder()
        }
    }
}