 ...
 */
class RoomCreateResponse internal constructor(var roomId: Long?) {

    class RoomCreateResponseBuilder internal constructor() {
        private var roomId: Long? = null
        fun roomId(roomId: Long?): RoomCreateResponseBuilder {
            this.roomId = roomId
            return this
        }

        fun build(): RoomCreateResponse {
            return RoomCreateResponse(roomId)
        }

        override fun toString(): String {
            return "RoomCreateResponse.RoomCreateResponseBuilder(roomId=" + roomId + ")"
        }
    }
    ...
    companion object {
         ...
         */
        fun toRoomCreateResponse(messageRoom: MessageRoom): RoomCreateResponse {
            return RoomCreateResponse.Companion.builder()
                .roomId(messageRoom.roomId)
                .build()
        }

        fun builder(): RoomCreateResponseBuilder {
            return RoomCreateResponseBuilder()
        }
    }
}