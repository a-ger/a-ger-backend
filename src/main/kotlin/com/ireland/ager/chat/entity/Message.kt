package com.ireland.ager.chat.entityimport
 ...
 */
@Entity
class Message : BaseEntity, Serializable {
    @Id
    ...
    var messageRoom: MessageRoom? = null

    constructor(messageId: Long?, senderId: Long?, message: String?, messageRoom: MessageRoom?) {
    ...
    class MessageBuilder internal constructor() {
        ...
        fun messageId(messageId: Long?): Message.MessageBuilder {
            this.messageId = messageId
            return this
        }

        fun senderId(senderId: Long?): Message.MessageBuilder {
            this.senderId = senderId
            return this
        }

        fun message(message: String?): Message.MessageBuilder {
            this.message = message
            return this
        }

        fun messageRoom(messageRoom: MessageRoom?): Message.MessageBuilder {
            this.messageRoom = messageRoom
            return this
        }

        fun build(): Message {
            return Message(messageId, senderId, message, messageRoom)
        }

        override fun toString(): String {
            return "Message.MessageBuilder(messageId=" + messageId + ", senderId=" + senderId + ", message=" + message + ", messageRoom=" + messageRoom + ")"
        }
    }

    companion object {
        fun builder(): Message.MessageBuilder {
