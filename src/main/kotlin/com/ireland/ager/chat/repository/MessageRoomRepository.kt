...
com.ireland.ager.product.entity.*import org.springframework.stereotype.Repositoryimport

java.util.*
@Repository
interface MessageRoomRepository : JpaRepository<MessageRoom?, Long?>, MessageRoomRepositoryCustom {
    fun findMessageRoomByProductAndBuyerId(product: Product?, buyerId: Account?): Optional<MessageRoom?>?
    fun findMessageRoomByRoomId(roomId: Long?): Optional<MessageRoom?>
}