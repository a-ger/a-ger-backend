...
class ProductRequest {
    ...
    fun toProduct(
        account: Account?,
        uploadImageUrl: List<String?>?, thumbNailUrl: String?
    ): Product {
        val product = Product()
    ...
    override fun equals(o: Any?): Boolean {
        ...
        if (o !is ProductRequest) return false
        val other = o
        ...
        return if (if (`this$category` == null) `other$category` != null else `this$category` != `other$category`) false else true
    }
    ...
    override fun toString(): String {
        return "ProductRequest(productName=" + productName + ", productPrice=" + productPrice + ", productDetail=" + productDetail + ", category=" + this.category + ")"
    }
}