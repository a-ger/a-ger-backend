 ...
 */
class ProductUpdateRequest {
    var productName: @NotBlank(message = "3010") String? = null
    var productPrice: @NotBlank(message = "3020") @Min(value = 0, message = "3021") String? = null
    var productDetail: @NotBlank(message = "3030") String? = null
    var category: @NotBlank(message = "3040") String? = null
    var status: @NotBlank(message = "3050") String? = null
    ...
    fun toProductUpdate(
        ...
        product.productViewCnt = product.productViewCnt
        product.productName = productName
        product.status = ProductStatus.valueOf(status!!)
        product.category = Category.valueOf(this.category!!)
        return product
    }

    override fun equals(o: Any?): Boolean {
        if (o === this) return true
        if (o !is ProductUpdateRequest) return false
        val other = o
    ...
    override fun toString(): String {
        return "ProductUpdateRequest(productName=" + productName + ", productPrice=" + productPrice + ", productDetail=" + productDetail + ", category=" + this.category + ", status=" + status + ")"
    }

    companion object {
        private val log = LoggerFactory.getLogger(ProductUpdateRequest::class.java)
    }
}