 ...
 */
class ProductThumbResponse internal constructor(
    ...
    override fun equals(o: Any?): Boolean {
        ...
        if (o !is ProductThumbResponse) return false
        val other = o
        ...
        val `this$productStatus`: Any? = productStatus
        val `other$productStatus`: Any? = other.productStatus
        if (if (`this$productStatus` == null) `other$productStatus` != null else `this$productStatus` != `other$productStatus`) return false
        ...
        return if (if (`this$thumbNailUrl` == null) `other$thumbNailUrl` != null else `this$thumbNailUrl` != `other$thumbNailUrl`) false else true
    }

    protected fun canEqual(other: Any?): Boolean {
        return other is ProductThumbResponse
    }
    ...
    override fun hashCode(): Int {
        ...
        val `$productStatus`: Any? = productStatus
        result = result * PRIME + (`$productStatus`?.hashCode() ?: 43)
    ...
    override fun toString(): String {
        return "ProductThumbResponse(productName=" + productName + ", productPrice=" + productPrice + ", productStatus=" + productStatus + ", productViewCnt=" + productViewCnt + ", category=" + this.category + ", createdAt=" + createdAt + ", thumbNailUrl=" + thumbNailUrl + ")"
    }

    class ProductThumbResponseBuilder internal constructor() {
        ...
        fun productName(productName: String?): ProductThumbResponseBuilder {
            this.productName = productName
            return this
        }

        fun productPrice(productPrice: String?): ProductThumbResponseBuilder {
            this.productPrice = productPrice
            return this
        }

        fun productStatus(productStatus: String?): ProductThumbResponseBuilder {
            this.productStatus = productStatus
            return this
        }

        fun productViewCnt(productViewCnt: Long?): ProductThumbResponseBuilder {
            this.productViewCnt = productViewCnt
            return this
        }

        fun category(category: Category?): ProductThumbResponseBuilder {
            this.category = category
            return this
        }

        fun createdAt(createdAt: LocalDateTime?): ProductThumbResponseBuilder {
            this.createdAt = createdAt
            return this
        }

        fun thumbNailUrl(thumbNailUrl: String?): ProductThumbResponseBuilder {
            this.thumbNailUrl = thumbNailUrl
            return this
        }

        fun build(): ProductThumbResponse {
        ...
        override fun toString(): String {
            return "ProductThumbResponse.ProductThumbResponseBuilder(productName=" + productName + ", productPrice=" + productPrice + ", productStatus=" + productStatus + ", productViewCnt=" + productViewCnt + ", category=" + this.category + ", createdAt=" + createdAt + ", thumbNailUrl=" + thumbNailUrl + ")"
        }
    }
    ...
    companion object {
         ...
         * @Return : ProductThumbResponse
         */
        fun toProductThumbResponse(product: Product?): ProductThumbResponse {
            return builder()
        ...
        fun toProductListResponse(productList: List<Product?>): List<ProductThumbResponse> {
            val productResponseList: MutableList<ProductThumbResponse> = ArrayList()
            for (product in productList) {
                val productResponse = toProductThumbResponse(product)
                productResponseList.add(productResponse)
            }
            return productResponseList
        }

        fun builder(): ProductThumbResponseBuilder {
            return ProductThumbResponseBuilder()
        }
    }
}