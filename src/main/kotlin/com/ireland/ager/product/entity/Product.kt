...
class Product : BaseEntity, Serializable {
    ...
    var urlList: MutableList<Url>? = ArrayList()
     ...
     * @Return : null
     */
    fun addAccount(updateAccount: Account?) {
    ...
    override fun equals(o: Any?): Boolean {
        ...
        return if (if (`this$productId` == null) `other$productId` != null else `this$productId` != `other$productId`) false else true
    }
    ...
    class ProductBuilder internal constructor() {
        ...
        private var urlList: MutableList<Url>? = null
        private var account: Account? = null
        fun productId(productId: Long?): ProductBuilder {
            this.productId = productId
            return this
        }

        fun productName(productName: String?): ProductBuilder {
            this.productName = productName
            return this
        }

        fun productPrice(productPrice: String?): ProductBuilder {
            this.productPrice = productPrice
            return this
        }

        fun productDetail(productDetail: String?): ProductBuilder {
            this.productDetail = productDetail
            return this
        }

        fun productViewCnt(productViewCnt: Long?): ProductBuilder {
            this.productViewCnt = productViewCnt
            return this
        }

        fun category(category: Category?): ProductBuilder {
            this.category = category
            return this
        }

        fun status(status: ProductStatus?): ProductBuilder {
            this.status = status
            return this
        }

        fun thumbNailUrl(thumbNailUrl: String?): ProductBuilder {
            this.thumbNailUrl = thumbNailUrl
            return this
        }

        fun urlList(urlList: MutableList<Url>?): ProductBuilder {
            this.urlList = urlList
            return this
        }

        fun account(account: Account?): ProductBuilder {
            this.account = account
            return this
        }
        ...
        override fun toString(): String {
            return "Product.ProductBuilder(productId=" + productId + ", productName=" + productName + ", productPrice=" + productPrice + ", productDetail=" + productDetail + ", productViewCnt=" + productViewCnt + ", category=" + this.category + ", status=" + status + ", thumbNailUrl=" + thumbNailUrl + ", urlList=" + urlList + ", account=" + account + ")"
        }
    }
