...
class Url : Serializable {
    ...
    constructor(urlId: Long?, productId: Product?, url: String?) {
        this.urlId = urlId
    ...
    override fun equals(o: Any?): Boolean {
        ...
        if (o !is Url) return false
        val other = o
        if (!other.canEqual(this as Any)) return false
        val `this$urlId`: Any? = urlId
        val `other$urlId`: Any? = other.urlId
        return if (if (`this$urlId` == null) `other$urlId` != null else `this$urlId` != `other$urlId`) false else true
    }
    ...
    override fun hashCode(): Int {
        ...
        var result = 1
        val `$urlId`: Any? = urlId
        result = result * PRIME + (`$urlId`?.hashCode() ?: 43)
        return result
    }
    ...
    class UrlBuilder internal constructor() {
        ...
        fun urlId(urlId: Long?): UrlBuilder {
            this.urlId = urlId
            return this
        }

        fun productId(productId: Product?): UrlBuilder {
            this.productId = productId
            return this
        }
        ...
        fun build(): Url {
            return Url(urlId, productId, url)
        }

        override fun toString(): String {
            return "Url.UrlBuilder(urlId=" + urlId + ", productId=" + productId + ", url=" + url + ")"
        }
    }
