...
interface ProductRepositoryCustom {
    fun addViewCntFromRedis(productId: Long?, addCnt: Long?)
    fun addViewCnt(productId: Long?): Product?
    fun findAllProductPageableOrderByCreatedAtDesc(
        category: Category,
        keyword: String,
        pageable: Pageable
    ): Slice<ProductThumbResponse>

    fun findSellProductsByAccountId(accountId: Long?, pageable: Pageable): Slice<ProductThumbResponse>
}