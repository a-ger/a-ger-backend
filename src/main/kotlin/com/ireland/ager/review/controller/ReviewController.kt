...
class ReviewController {
     ...
     * @Return : ResponseEntity<SingleResult></SingleResult><ReviewResponse>>
    </ReviewResponse> */
    @PostMapping("/{roomId}")
    ...
    fun postReview(
        ...
        @ApiParam(value = "리뷰 내용", required = true) @RequestPart(value = "review") reviewRequest: ReviewRequest
    ): ResponseEntity<SingleResult<ReviewResponse?>?> {
