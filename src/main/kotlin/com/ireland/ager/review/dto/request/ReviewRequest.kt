...
class ReviewRequest {
    ...
    override fun equals(o: Any?): Boolean {
        ...
        if (o !is ReviewRequest) return false
        val other = o
        ...
        return if (stars != other.stars) false else true
    }
    ...
    override fun toString(): String {
        return "ReviewRequest(comment=" + comment + ", stars=" + stars + ")"
    }
    ...
    companion object {
         ...
         * @Return : Review
         */
        fun toReview(reviewRequest: ReviewRequest, seller: Account, product: Product, buyer: Account?): Review {
            val review = Review()
            review.addAccount(seller)
            review.comment = reviewRequest.comment
            review.stars = reviewRequest.stars
            review.buyerNickname = buyer.getProfileNickname()
            review.buyerId = buyer.getAccountId()
            review.sellerNickname = seller.profileNickname
            review.title = product.productName
            return review
        }
    }
}