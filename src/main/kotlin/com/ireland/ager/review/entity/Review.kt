...
class Review : BaseEntity {
    ...
    class ReviewBuilder internal constructor() {
        private var reviewId: Long? = null
        private var comment: String? = null
        private var title: String? = null
        private var buyerNickname: String? = null
        private var buyerId: Long? = null
        private var sellerNickname: String? = null
        private var stars = 0
        private var sellerId: Account? = null
        fun reviewId(reviewId: Long?): ReviewBuilder {
            this.reviewId = reviewId
            return this
        }

        fun comment(comment: String?): ReviewBuilder {
            this.comment = comment
            return this
        }
        ...
        fun buyerNickname(buyerNickname: String?): ReviewBuilder {
            this.buyerNickname = buyerNickname
            return this
        }

        fun buyerId(buyerId: Long?): ReviewBuilder {
            this.buyerId = buyerId
            return this
        }

        fun sellerNickname(sellerNickname: String?): ReviewBuilder {
            this.sellerNickname = sellerNickname
            return this
        }

        fun stars(stars: Int): ReviewBuilder {
            this.stars = stars
            return this
        }

        fun sellerId(sellerId: Account?): ReviewBuilder {
            this.sellerId = sellerId
            return this
        }

        fun build(): Review {
            return Review(reviewId, comment, title, buyerNickname, buyerId, sellerNickname, stars, sellerId)
        }

        override fun toString(): String {
            return "Review.ReviewBuilder(reviewId=" + reviewId + ", comment=" + comment + ", title=" + title + ", buyerNickname=" + buyerNickname + ", buyerId=" + buyerId + ", sellerNickname=" + sellerNickname + ", stars=" + stars + ", sellerId=" + sellerId + ")"
        }
    }

    companion object {
        fun builder(): ReviewBuilder {
